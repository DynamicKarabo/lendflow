  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-emerald-500/15 text-emerald-400 shadow-sm",
        warning: "border-transparent bg-amber-500/15 text-amber-400 shadow-sm",
        info: "border-transparent bg-sky-500/15 text-sky-400 shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
